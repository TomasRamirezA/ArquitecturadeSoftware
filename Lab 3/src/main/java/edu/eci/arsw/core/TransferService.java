...
/**
 * Service for transferring funds between bank accounts with different locking
 * strategies.
 */
public final class TransferService {

  /**
   * Transfers funds using naive locking (may deadlock).
   */
  ...
  /**
   * Transfers funds using ordered locking (deadlock-free).
   */
  ...
  /**
   * Transfers funds using tryLock with timeout (deadlock-free with retry).
   */
